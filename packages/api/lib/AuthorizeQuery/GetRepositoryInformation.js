...
export const handler = async (input) => resolverFor('AuthorizeQuery', 'GetRepositoryInformation', async (args, src) => {
    ...
    const contributors = collaborators.data.map((u) => prepareUserPayload(u));
